...
public class Variable {
	...
	// 변수 : Memory(RAM)에 값을 저장하기 위한 공간         음 저장된 공간 
	
		// 변수 그냥 한 번 써보기 --> 설명을 위해서 하는것 절대로 쓰면 안돼! 변수는 긴바지 반바지
		...
		public void findLunchMenu() {
			...
			System.out.print(8397 * 9);                 // 밑에랑 붙여쓰고싶어 System.out.println((8397 * 9) + "원 입니다.");
			System.out.println("원 입니다.");
			System.out.println("1955 4개 주문");
			System.out.println("44000원 입니다.");
			System.out.println("----------------------");
			
			System.out.println("트리플치즈버거 4개 주문");
			System.out.println((10000 * 4) + "원 입니다.");
			...
			public void declareVariable() {
				 ...
				 * 
				 * 자료형(DataType) 변수식별자;
				 * 권장하는 방법은 아니지만 동일한 타입의 변수를 선얼할 때는 한번에 선언 할 수 있음
				 ...
				 * 
				 * 1. keyword(예약어)는 식별자로 사용할 수 없음 ex) int static;
				 * 2. 공백은 포함할 수 없음 ex) int sta tic;
				 * 3. 대, 소문자를 구분하고 길이제한은 없음 ex) int age; int Age;, int aGe; 서로 다른 변수로 이해
				 * 4. 문자, 숫자, _, $ 를 포함할 수 있음 ex) int age2_$; 특수문자 _,$ 2개만 가능
				 * 5. 문자, _, $로만 시작할 수 있음 ex) int 2age;(x) 
				 * 
				 * 
				 ...
				 * 
				 * -> welcomtojavaworld -> WelcomeToJavaWorld
				 * 
				 * 
				 * 2. 변수 명명 규칙
				 * - 명사적 의미를 갖게 만들어 줌
				 ...
				 * - 동사적 의미를 갖게 만들어줌
				 * - 첫 글자를 소문자로 표기, 연결된 단어들의 첫글자를 대문자로 표기 
				 * - 메소드 식별자의 경우 식별자 뒤에 반드시 한 쌍의 "()"를 명명
				 ...
				 * float형을 사용하기 위해서는 할당할 숫자 뒤에 "F"를 붇여야함
				 * 
				 * 
				 */
				...
				byte byteNumber = 1;	// 1Byte       1bit * 8 = 1Byte
				...
				System.out.println("정수 자로형 : " + longNumber);
				...
				// %s, %S : 문자열
				System.out.println();
				System.out.println(doubleNumber); // = 3.33
				System.out.printf("doubleNumber 값 : %.3f", doubleNumber); // = %.숫자f 숫자까지 소수점 보여줌
