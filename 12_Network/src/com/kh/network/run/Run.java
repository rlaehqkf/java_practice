...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 네트워크(Network)
		 * 
		 * 통신이 가능한 두 대 이상의 장치들을 물리적 또는 논리적으로 연결한 환경
		 * 
		 * 네트워크의 목적 : 데이터의 교환
		 * 
		 ...
		 * 
		 * 
		 * IP(Internet Protocol) Adress / MAC(Media Access Controller) Adress
		 * 
		 * - MAC Adress	: NIC(Network Interface Card)에 제조 시 붙여지는 물리적인 주소
		 * 
		 * - IP Address	: Internet상에서 각 Host들을 식별할 수 있는 논리적인 주소 (도로명주소같은) 
		 * 
		...
		try {
			...
			// localHost : 현재 프로그램을 동작시킨 장치의 의미
			 ...
			 * 
			 * 자바만 가지고 클라이언트와 서버의 간단한 통신하는 프로그램 구현
			 * 
			 * 소켓(Socket)
			 * 
