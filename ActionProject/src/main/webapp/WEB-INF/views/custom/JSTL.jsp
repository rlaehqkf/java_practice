...
<body>
	...
	<p>
		...
		공통적으로 화면단에서 사용하게 되는 코드들의 어떤 집합을 보다 쉽게 사용할 수 있게끔 태그로 만들어거 <br>
	...
	<ol>
		<li>https://tomcat.apache.org로접속</li>
	...
	<p>
		JSTL을 사용하는 방법은 일단 사용하고자하는 JSP파일 상단에 <br>
		보통 page지시어 바로 밑에<br>
	...
	set태그로 선언한 Attribute는 EL구문을 이용해출력 <br>
	num1의 값 : ${ num1 } <br> 
	num2의 값 : ${ num2 } <br>
	result의 값 ${ result } <br>
	...
	<!-- choose구문안에 when/otherwise말고 다른 어떤 무언가가 들어가서는 안됨! -->
	...
	<pre>
		...
		향상된 for문
		&lt;c:forEach var="속성명" items="순차적으로요소에 접근할 배열 / 컬렉션" varStatu="상태값">
		&lt;/c:forEach>
	...
	<c:set var="colors">
		red, orangeres, orange, yellow, yellowgreen, forestgreen
	</c:set>
	...
	<c:set var="device" value="컴퓨터,핸드폰,TV/에어컨.냉장고-사탁기" />
